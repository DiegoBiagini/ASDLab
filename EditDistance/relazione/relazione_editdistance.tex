...
\cline{2-5}
\multicolumn{1}{l|}{} & \begin{tabular}[c]{@{}l@{}}Almeno un\\n-gram\end{tabular} & \begin{tabular}[c]{@{}l@{}}Coefficiente di\\Jaccard \textbackslash{}geq 0.2\end{tabular} & \begin{tabular}[c]{@{}l@{}}Coefficiente di\\Jaccard \textbackslash{}geq 0.5\end{tabular} & \begin{tabular}[c]{@{}l@{}}Coefficiente di \\Jaccard \textbackslash{}geq 0.8\end{tabular}  \\ 
\hline
